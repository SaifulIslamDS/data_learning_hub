...
def build_content() -> dict:
    ...
    return {
        ...
        "release_roadmap": [
            ...
            {"version": "v2.2.0", "title_en": "Complete Excel for Data Analytics tutorial", "title_bn": "Data Analytics-এর জন্য complete Excel tutorial", "status": "current"},
