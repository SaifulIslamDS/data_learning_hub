...
def build_content() -> dict:
    ...
    return {
        ...
        "release_roadmap": [
            ...
            {"version": "v2.3.0", "title_en": "Complete SQL tutorial with browser practice", "title_bn": "Browser practiceসহ complete SQL tutorial", "status": "current"},
