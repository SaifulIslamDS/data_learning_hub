...
def build_content() -> dict:
    ...
    return {
        ...
        "release_roadmap": [
            ...
            {"version": "v2.4.0", "title_en": "Complete Power BI tutorial", "title_bn": "Complete Power BI tutorial", "status": "current"},
