...
def build_content() -> dict:
    ...
    return {
        ...
        "release_roadmap": [
            ...
            {"version": "v2.5.0", "title_en": "Complete Python for Analytics tutorial", "title_bn": "Complete Python for Analytics tutorial", "status": "current"},
