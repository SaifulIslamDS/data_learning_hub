(() => {
  ...
  function renderFooter() {
    ...
    if (!root) return;
    root.innerHTML = `<footer class="site-footer"><div class="container footer-grid"><div class="footer-brand"><a class="brand" href="/"><span class="brand-mark">${icons.logo}</span><span class="brand-text">Data Learning Hub<small data-en="Foundations → tools → portfolio" data-bn="Foundation → tool → portfolio">${t('Foundations → tools → portfolio', 'Foundation → tool → portfolio')}</small></span></a><p data-en="Learn Data Analytics through connected concepts, practice, tools, datasets and projects." data-bn="Connected concept, practice, tool, dataset ও project দিয়ে Data Analytics শিখুন।">${t('Learn Data Analytics through connected concepts, practice, tools, datasets and projects.', 'Connected concept, practice, tool, dataset ও project দিয়ে Data Analytics শিখুন।')}</p></div><div class="footer-column"><h3 data-en="Tutorials" data-bn="টিউটোরিয়াল">${t('Tutorials', 'টিউটোরিয়াল')}</h3><a href="/tutorials/data-foundations/">${t('Data Foundations', 'Data Foundations')}</a><a href="/tutorials/excel-data-analytics/">${t('Excel for Data Analytics', 'Data Analytics-এর জন্য Excel')}</a><a href="/tutorials/sql-data-analytics/">SQL for Data Analytics</a><a href="/tutorials/power-bi-data-analytics/">Power BI for Data Analytics</a><a href="/tutorials/python-data-analytics/">Python for Data Analytics</a><a href="/tutorials/data-analytics-workflows/">Analytics Workflows</a><a href="/exercises/">${t('Exercises', 'Exercise')}</a></div><div class="footer-column"><h3 data-en="Resources" data-bn="Resource">${t('Resources', 'Resource')}</h3><a href="/examples/">${t('Examples', 'Example')}</a><a href="/references/">${t('References', 'Reference')}</a><a href="/projects/">${t('Projects', 'প্রজেক্ট')}</a><a href="/my-learning/">${t('My Learning', 'আমার শেখা')}</a></div><div class="footer-column"><h3 data-en="Creator" data-bn="Creator">${t('Creator', 'Creator')}</h3><a href="${DATA.site.website}" target="_blank" rel="noopener noreferrer">Website ↗</a><a href="${DATA.site.github}" target="_blank" rel="noopener noreferrer">GitHub ↗</a><a href="${DATA.site.linkedin}" target="_blank" rel="noopener noreferrer">LinkedIn ↗</a></div></div><div class="container footer-bottom"><span>Idea and developed by Saiful Islam.</span><div class="footer-bottom-links"><a href="/about/">About</a></div></div></footer>`;
  }
