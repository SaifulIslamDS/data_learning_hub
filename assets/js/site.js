(() => {
  ...
  function renderSearch() {
    ...
    if (!root) return;
    root.innerHTML = `<div class="search-overlay" aria-hidden="true"><div class="search-dialog" role="dialog" aria-modal="true" aria-label="Site search"><div class="search-dialog-header">${icons.search}<input id="global-search-input" type="search" placeholder="${t('Search lessons, labs, curricula and projects…', 'Lesson, lab, curriculum ও project খুঁজুন…')}" data-placeholder-en="Search lessons, labs, curricula and projects…" data-placeholder-bn="Lesson, lab, curriculum ও project খুঁজুন…"><button class="icon-button" id="close-search" type="button" aria-label="${t('Close search', 'সার্চ বন্ধ করুন')}">${icons.close}</button></div><div class="search-results" id="global-search-results"></div></div></div>`;
  ...
  function statusLabel(status) {
    return ({ available:t('Available now', 'এখন available'), 'curriculum-ready':t('Curriculum ready', 'Curriculum ready'), 'foundation-ready':t('Foundation ready', 'Foundation ready'), roadmap:t('Future roadmap', 'Future roadmap') })[status] || status;
  }
  function renderHome() {
